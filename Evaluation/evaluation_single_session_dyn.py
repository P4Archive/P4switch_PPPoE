...
#   calculate packet rate at the time scale of 0.01m
   ...
   with open(r'/home/zhiqiang.qian/evaluation/evaluation_single_session_dyn_log.txt', 'w') as f:
        f.write("VM8(ckient 1) packet rate: \n {0}\n\n VNF packet rate: \n {1}\n\n HWA packet rate: \n {2}\n\n Synchronization packet rate: \n {3}\n\n Synchronization in HWA packet rate: \n {4}\n\n Rule configuration in FDP packet rate: \n {5}".format(packet_rates_vm8,packet_rates_vnf,packet_rates_hwa,packet_rates_sync,packet_rates_hwa_sync,packet_rates_fdp))
