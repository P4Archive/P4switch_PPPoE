...
#   calculate packet rate at the time scale of 0.01m
   ...
   with open(r'/home/zhiqiang.qian/evaluation/evaluation_multiple_session_log.txt', 'w') as f:
        f.write("VM8(ckient 1) packet rate: \n {0}\n\n VM9(ckient 2) packet rate: \n {1}\n\n VM10(ckient 3) packet rate: \n {2}\n\n VM11(ckient 4) packet rate: \n {3}\n\n VNF packet rate: \n {4}\n\n HWA packet rate: \n {5}\n\n Synchronization packet rate: \n {6}\n\n Synchronization in HWA packet rate: \n {7}\n\n".format(packet_rates_vm8,packet_rates_vm9,packet_rates_vm10,packet_rates_vm11,packet_rates_vnf,packet_rates_hwa,packet_rates_sync,packet_rates_hwa_sync))
